    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Purchasing Order
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"></a>
                </h1> 
            </div>
        </div>
        <!-- /.row -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2023';?> by Kelompok 3 | UTS</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
